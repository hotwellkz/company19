    ...
    const loadEstimateData = async () => {
      try {
        ...
        if (estimateDoc.exists()) {
          ...
          setFirstFloorHeight(data.firstFloorHeight);
          setSecondFloorHeight(data.secondFloorHeight);
          setFoundationValues(data.foundationValues);
          setLumberValues(data.lumberValues);
          setRoofValues(data.roofValues);
        }
      } catch (error) {
